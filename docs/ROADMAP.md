...
### Content Quality
- 382 bilingual questions across 10 categories (q001–q382, ~38 per category, 30 minimum reached ✅).
...
- Current: **~38 questions per category** (q001–q382). ✅ 30-question minimum cleared.
- Next batch starts at `q383`. Target: 50 questions per category.
- Add balanced batches using `scripts/inject-batch4.mjs` (create when ready, follow same pattern as batch 3).
